              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input value={customerName} onChange={e => setCustomerName(e.target.value)}
                    className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400" placeholder="Optional"/>
                </div>
                <div>
                      ...
                      <div key={i} className="border border-gray-100 rounded-xl p-3 bg-gray-50">
                        <div className="flex items-center gap-2 mb-2">
                          <select value={item.cashewTypeId} onChange={e => updateItem(i, 'cashewTypeId', +e.target.value)}
                            className="flex-1 border border-gray-200 rounded-lg px-2 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400 bg-white">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <div>
                            ...
                            <input type="number" value={item.qtyKg} onChange={e => updateItem(i, 'qtyKg', e.target.value)}
                              className="w-full border border-gray-200 rounded-lg px-2 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400"
